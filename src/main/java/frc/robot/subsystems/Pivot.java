...
public class Pivot extends SubsystemBase {
    ...
    public void periodic() {
        ...
        switch (this.mControlMode) {
            ...
            case kManualPosition:
                ...
                this.mSetPoint = MathUtil.clamp(this.mSetPoint + this.mInput.getAsDouble(),
                        Settings.Positioner.minPivotPosition,
                        Settings.Positioner.maxPivotPosition);
        ...
        SmartDashboard.putNumber("Pivot/speed", this.leftMotor.get());
        SmartDashboard.putNumber("Pivot/voltage", this.leftMotor.getBusVoltage());
        SmartDashboard.putNumber("Pivot/Current", this.leftMotor.getOutputCurrent());
    }
}
