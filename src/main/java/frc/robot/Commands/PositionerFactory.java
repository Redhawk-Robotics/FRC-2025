...
public final class PositionerFactory {
    ...
    static class GoToState extends Command {
            ...
            if (extraStates > 2) {
                ...
                if (startZone < endZone) {
                    if (startZone == 1) {
                        ...
                        pivotPos = Settings.Positioner.minPositionWherePivotDoesNotCollideWithElevator;
        ...
        public void initialize() {
            ...
            if (goal.pivotSetPoint != null && (goal.pivotSetPoint < Settings.Positioner.minPivotPosition
            ...
            if (goal.spoilerSetPoint != null && (goal.spoilerSetPoint < Settings.Positioner.minSpoilerPosition
    ...
    private static State ElevatorAndPivotToPosition(Elevator elevator, double elevatorPosition,
        ...
        BooleanSupplier done = () -> {
            return (Math
                    .abs(elevator.getPosition() - elevatorPosition) < Settings.Positioner.allowedElevatorError)
                    && (Math.abs(pivot.getPosition() - pivotPosition) < Settings.Positioner.allowedPivotError);
        };
    ...
    private static State ElevatorAndPivotAndSpoilerToPosition(Elevator elevator, double elevatorPosition,
        ...
        BooleanSupplier done = () -> {
            return (Math
                    .abs(elevator.getPosition() - elevatorPosition) < Settings.Positioner.allowedElevatorError)
                    && (Math.abs(pivot.getPosition() - pivotPosition) < Settings.Positioner.allowedPivotError)
                    && (Math.abs(spoiler.getPosition() - spoilerPosition) < Settings.Positioner.allowedSpoilerError);
        };
    ...
    public static Command Feed(Elevator elevator, Pivot pivot, AlgaeArm spoiler) {
        ...
        State goal = PositionerFactory.ElevatorAndPivotAndSpoilerToPosition(elevator,
                Settings.Positioner.ELEVATOR_FEED_POSITION, pivot, Settings.Positioner.PIVOT_FEED_POSITION ,spoiler, Settings.Positioner.SPOILER_ALGAE_FEED_POSITION);
    ...
    public static Command Attack(Elevator elevator, Pivot pivot, AlgaeArm spoiler) {
        State goal = PositionerFactory.ElevatorAndPivotToPosition(elevator,
                Settings.Positioner.ELEVATOR_ATTACK_POSITION, pivot, Settings.Positioner.PIVOT_ATTACK_POSITION);
    ...
    public static Command L1(Elevator elevator, Pivot pivot, AlgaeArm spoiler) {
        State goal = PositionerFactory.ElevatorAndPivotToPosition(elevator,
                Settings.Positioner.ELEVATOR_L1_POSITION, pivot, Settings.Positioner.PIVOT_L1_POSITION);
    ...
    public static Command L2(Elevator elevator, Pivot pivot, AlgaeArm spoiler) {
        State goal = PositionerFactory.ElevatorAndPivotToPosition(elevator,
                Settings.Positioner.ELEVATOR_L2_POSITION, pivot, Settings.Positioner.PIVOT_L2_POSITION);
    ...
    public static Command L3(Elevator elevator, Pivot pivot, AlgaeArm spoiler) {
        State goal = PositionerFactory.ElevatorAndPivotToPosition(elevator,
                Settings.Positioner.ELEVATOR_L3_POSITION, pivot, Settings.Positioner.PIVOT_L3_POSITION);
    ...
    public static Command L4(Elevator elevator, Pivot pivot, AlgaeArm spoiler) {
        State goal = PositionerFactory.ElevatorAndPivotToPosition(elevator,
                Settings.Positioner.ELEVATOR_L4_POSITION, pivot, Settings.Positioner.PIVOT_L4_POSITION);
    ...
    public static Command Barge(Elevator elevator, Pivot pivot, AlgaeArm spoiler) {
        State goal = PositionerFactory.ElevatorAndPivotToPosition(elevator,
                Settings.Positioner.ELEVATOR_BARGE_POSITION, pivot, Settings.Positioner.PIVOT_BARGE_POSITION);
    ...
    public static Command AlgaeL2(Elevator elevator, Pivot pivot, AlgaeArm spoiler) {
        State goal = PositionerFactory.ElevatorAndPivotToPosition(elevator,
                Settings.Positioner.ELEVATOR_ALGAE_L2_POSITION, pivot, Settings.Positioner.PIVOT_ALGAE_L2_POSITION);
    ...
    public static Command AlgaeL3(Elevator elevator, Pivot pivot, AlgaeArm spoiler) {
        State goal = PositionerFactory.ElevatorAndPivotToPosition(elevator,
                Settings.Positioner.ELEVATOR_ALGAE_L3_POSITION, pivot, Settings.Positioner.PIVOT_ALGAE_L3_POSITION);
    ...
    public static Command AlgaeGround(Elevator elevator, Pivot pivot, AlgaeArm spoiler) {
        State goal = PositionerFactory.ElevatorAndPivotAndSpoilerToPosition(elevator,
                ...
                Settings.Positioner.PIVOT_ALGAE_GROUND_POSITION, spoiler, Settings.Positioner.SPOILER_ALGAE_GROUND_POSITION);
    ...
    public static Command AlgaeTransfer(Elevator elevator, Pivot pivot, AlgaeArm spoiler) {
        State goal = PositionerFactory.ElevatorAndPivotAndSpoilerToPosition(elevator,
                ...
                Settings.Positioner.PIVOT_ALGAE_TRANSFER_POSITION, spoiler, Settings.Positioner.SPOILER_ALGAE_TRANSFER_POSITION);
