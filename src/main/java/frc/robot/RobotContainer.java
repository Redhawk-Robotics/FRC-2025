...
public class RobotContainer {
        ...
        private final AprilTagTracker AprilTagTracker = new AprilTagTracker();
        private final CommandXboxController DRIVER = new CommandXboxController(Settings.Gamepad.DRIVER);
        private final CommandXboxController OPERATOR = new CommandXboxController(Settings.Gamepad.OPERATOR);
        ...
        // private final AlgaeHandler sysAlgaeHandler = new AlgaeHandler(); // TODO
        // re-enable
        private final AlgaeRoller sysRoller = new AlgaeRoller();
        // private final CANRanges sysCANRanges = new CANRanges(); // TODO re-enable (if
        // using)

        private final ControlBoard LAPTOP = new ControlBoard(this.sysElevator, this.sysPivot, this.sysSpoiler);
        ...
        private final SendablePID elevatorUpPID = new SendablePID("Elevator.Up", (float) Settings.Elevator.kP,
                ...
                return this.drive//
                                ...
                                .withRotationalRate( // Drive counterclockwise with negative X (left)
                                                MathUtil.applyDeadband(-this.DRIVER.getRightX(), 0.05)//
                                                                * this.MaxAngularRate
                                                                * this.drivetrain.speedMultiplier());
        }
        ...
        private void configureDriverBindings() {
                ...
                this.DRIVER.y()
                                .whileTrue(this.drivetrain
                                                .applyRequest(() -> this.point.withModuleDirection(
                                                                new Rotation2d(this.DRIVER.getLeftY(),
                ...
                // DRIVER.rightBumper().onTrue(new RunToPose(drivetrain, sysVision)).onFalse(new
                ...
                // this.DRIVER.povLeft().whileTrue(AutoAlign.alignToLeftReef(drivetrain,
                // sysCANRanges));
                // this.DRIVER.povRight().whileTrue(AutoAlign.alignToRightReef(drivetrain,
                // sysCANRanges));
        ...
        private void configureOperatorBindings() {
                ...
                if (this.enablePIDTuningMode) {
                        ...
                        this.OPERATOR.a().whileTrue(//
                                        ...
                                        .onFalse(
                                                        PositionerFactory
                                                                        .Stop(this.sysElevator, this.sysPivot,
                                                                                        this.sysSpoiler)
                ...
                // on start-button (right-center button), tell the elevator and pivot to use
                // _speed_ control
        ...
        public Command getAutonomousCommand() {
                // TODO remove
                // return new DriveToPose(this.drivetrain, new Pose2d(12, 6, new
                // Rotation2d(6)));
        ...
        private void configureNamedCommands() {
                ...
                // TODO add in
                // NamedCommands.registerCommand("Run Algae Intake",
                // this.sysAlgaeHandler.rotateCW_Intake());
                // NamedCommands.registerCommand("Run Algae Contain",
                // this.sysAlgaeHandler.contain());
                // NamedCommands.registerCommand("Run Algae Outake",
                // this.sysAlgaeHandler.rotateCCW_Outtake());
                ...
                // new EventTrigger("Run Algae
                // Intake").onTrue(this.sysAlgaeHandler.rotateCW_Intake());
