...
public final class PositionerFactory {
    ...
    private static final class Settings {
        ...
        public static final double PIVOT_MIN_BLOCKING_POSITION = 120.; // pivot blocks the elevator below this reference
        public static final double ELEVATOR_ALLOWED_ERROR = 1;
        public static final double PIVOT_ALLOWED_ERROR = 0.5;
        ...
        // TODO tune these!
        // and then put them into Settings
        private static final double minPositionWhereElevatorFreesPivotAndSpoiler = 1;
        private static final double minPositionWherePivotDoesNotCollideWithSpoiler = 10;
        private static final double minPositionWhereSpoilerDoesNotCollideWithPivot = 1;
        private static final double minPositionWherePivotDoesNotCollideWithElevator = 10; // threshold_p_e
        private static final double minPositionWhereElevatorDoesNotBlockPivot = 2; // threshold_e_p1
        private static final double maxPositionWhereElevatorDoesNotBlockPivot = 20; // threshold_e_p2
        private static final double midpointPositionWhereElevatorBlocksPivot =
                (minPositionWhereElevatorDoesNotBlockPivot
                        + maxPositionWhereElevatorDoesNotBlockPivot) / 2;
        private static final double minElevatorPosition = 0;
        private static final double maxElevatorPosition = 100;
        private static final double minPivotPosition = 0;
        private static final double maxPivotPosition = 10;
        private static final double minSpoilerPosition = 0;
        private static final double maxSpoilerPosition = 10;
        private static final double allowedElevatorError = 1;
        private static final double allowedPivotError = 1;
        private static final double allowedSpoilerError = 1;
    }
    ...
    private static class GoToState extends Command {
        private State goal;
        ...
        public GoToState(State goal, Elevator elevator, Pivot pivot, CoralHandler coral,
